...
public class NewSalesListingTest extends DefaultAcceptanceTest {
    
    private static final ObjectMapper MAPPER = new ObjectMapper();
    
    @Test
    @RunAsClient
    public void clientCanPostAnAssetForSale() throws Throwable
    {
        ListingDto newAssetJson = new ListingDto("aaa", 2000, 245);

        Response postResponse = httpPostAsJson("sales", newAssetJson);

        assertThat(postResponse.code(), is(200));

        Response getResponse = httpGet("sales");
